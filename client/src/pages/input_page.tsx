...
const Input: React.FC = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-blue-900 via-gray-900 to-black p-4">
      <div className="flex flex-col items-center justify-center bg-white/10 backdrop-blur-md p-8 rounded-lg shadow-2xl max-w-md w-full">
        ...
        <div className=" mt-5 w-full">
          <button
            ...
            className="w-full mt-8 bg-blue-500 hover:bg-blue-600 text-white px-6 py-3 rounded-lg font-semibold shadow-lg transition duration-300"
          >
            Analyze 🚀
          </button>
      </div>
